...
public class KNIExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(KNIDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new KNIStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static KNIDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static KNIDateTimeConverter dateTimeConverter = new KNIStandardDateTimeConverter();

    public KNIExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public KNIExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new KNIMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=KNIHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,KNIExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=KNIHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
