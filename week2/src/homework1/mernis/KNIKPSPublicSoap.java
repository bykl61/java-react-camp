...
public class KNIKPSPublicSoap
{
    ...
    public KNIKPSPublicSoap(){}

    public KNIKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public KNIKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        KNIExtendedSoapSerializationEnvelope envelope= new KNIExtendedSoapSerializationEnvelope(KNIExtendedSoapSerializationEnvelope.VER11);
