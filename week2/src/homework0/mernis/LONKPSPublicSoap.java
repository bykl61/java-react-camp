...
public class LONKPSPublicSoap
{
    ...
    public LONKPSPublicSoap(){}

    public LONKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public LONKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        LONExtendedSoapSerializationEnvelope envelope= new LONExtendedSoapSerializationEnvelope(LONExtendedSoapSerializationEnvelope.VER11);
